    ...
    <footer id="contact" class="bg-neutral-900 text-center text-white">
        <div class="md:px-6 px-10  pt-6">
            ...
            <div class="mb-6 flex justify-center">
                ...
                <a href="https://github.com/RYUUUKEN/RYUUUKEN" type="button" class="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-yellow-400  focus:outline-none focus:ring-0" data-te-ripple-init data-te-ripple-color="light">
                    <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-full w-4" fill="currentColor" viewBox="0 0 24 24">
